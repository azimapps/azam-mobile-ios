...
struct SettingsView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .alert(
                ...
                Text("Notifications are disabled at the system level. Open Settings to enable them for AzamCEO.")
            }
        }
        .task {
            if viewModel == nil {
    ...
    private var appCard: some View {
        VStack(spacing: 0) {
            SettingsRow(icon: "star.fill", iconColor: .orange, label: "Rate AzamCEO") {
                Image(systemName: "chevron.right")
                    .font(Theme.Typography.captionBold)
                    .foregroundStyle(Theme.TextColors.secondary)
            }
